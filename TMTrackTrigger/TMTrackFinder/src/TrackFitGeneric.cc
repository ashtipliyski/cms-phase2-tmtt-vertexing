...
//#include "TMTrackTrigger/TMTrackFinder/interface/globalLinearRegression3.h"
#include <map> 
#include <new>
...
TrackFitGeneric* TrackFitGeneric::create(std::string fitter, const Settings* settings){
  ...
  /*  }else if(fitter.compare("KF4Params")==0){
    ...
    }else if(fitter.compare("globalLinearRegression")==0){
        return new globalLinearRegression(settings, 4);
    }else if(fitter.compare("globalLinearRegression2")==0){
        return new globalLinearRegression2(settings, 4);
	//    }else if(fitter.compare("globalLinearRegression3")==0){
	//        return new globalLinearRegression3(settings, 4);
