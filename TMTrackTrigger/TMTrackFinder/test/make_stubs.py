...
#--- Specify input MC
options.register('inputMC', '../../../Samples81X/tilted_RelVal_ttbar_PU200.txt', VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.string, "Files to be processed")
