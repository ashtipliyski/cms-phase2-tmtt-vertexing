...
TMTrackProducer.StubDigitize = cms.PSet(
   ...
   FirmwareType    = cms.uint32(0),    # 0 = Old Thomas 2-cbin data format, 1 = new Thomas data format for daisy chain, 2-98 = reserved for demonstrator daisy chain use, 99 = Systolic array data format.
   ...
   PhiSRange       = cms.double(0.349066),   # Range phiS coord. covers in radians.
   RtBits          = cms.uint32(9),    # Bits used to store Rt coord.
   RtRange         = cms.double(100.), # Range Rt coord. covers in units of cm.
   ZBits           = cms.uint32(12),   # Bits used to store z coord.
   ZRange          = cms.double(800.), # Range z coord. covers in units of cm.
...
TMTrackProducer.PhiSectors.ChosenRofPhi  = cms.double(65.5)
