...
# TMTrackProducer.HTArraySpecRphi.MaxPtToMerge2x2    = cms.double(2.70)
# TMTrackProducer.HTFillingRphi.BusySectorMbinOrder  = cms.vuint32() # cant be trivially extrapolated to more Pt bins, so dont use.
...
TMTrackProducer.HTFillingRphi.BusySectorNumStubs   = cms.uint32(202)
...
TMTrackProducer.RZfilterOpts.zTrkSectorCheck       = cms.bool(True)
TMTrackProducer.RZfilterOpts.KeepAllSeed           = cms.bool(False)
...
TMTrackProducer.TrackFitSettings.ResidualCut       = cms.double(0.000527305895837402)
TMTrackProducer.TrackFitSettings.SLR_minstubs      = cms.uint32(4)
TMTrackProducer.TrackFitSettings.SLR_chi2cut       = cms.double(20.)
# TMTrackProducer.TrackFitSettings.TrackFitters    = cms.vstring("KF4ParamsComb")
# TMTrackProducer.TrackFitSettings.TrackFitters    = cms.vstring("globalLinearRegression")
TMTrackProducer.Debug                              = cms.uint32(0)
