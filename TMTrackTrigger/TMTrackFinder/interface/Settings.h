...
public:
  ...
  unsigned int         genMaxStubLayers()        const   {return genMaxStubLayers_;}
  bool                 genFirstLayerHit()        const   {return genFirstLayerHit_;}
  ...
  /// Number of bits to be used in hardware to compute the division needed to calculate the helix parameters in rz
...
private:
  ...
  unsigned int         genMaxStubLayers_;
  bool                 genFirstLayerHit_;
  // Cuts applied to stubs before arriving in L1 track finding board.
