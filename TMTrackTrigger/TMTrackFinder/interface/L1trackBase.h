...
protected:
  ...
  // Comparitors for sorting tracks using std::sort() -- Don't know how to put these into base class?.
  // static bool qOverPtSortPredicate(const L1track& t1, const L1track t2) = 0;
  // static bool numLayersSortPredicate(const L1track2D t1, const L1track2D t2) = 0;
  // static bool numLayersDescendingSortPredicate(const L1track2D t1, const L1track2D t2) = 0;
